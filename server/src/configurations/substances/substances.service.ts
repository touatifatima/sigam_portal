...
export class SubstancesService {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        throw new BadRequestException(
          'Failed to create substance: ' + error.message,
        );
  ...
  async update(id: number, updateSubstanceDto: UpdateSubstanceDto) {
    try {
      ...
      if (error instanceof Prisma.PrismaClientKnownRequestError) {
        ...
        throw new BadRequestException(
          'Failed to update substance: ' + error.message,
        );
  ...
  async remove(id: number) {
    try {
      ...
      const associatedDemands =
        await this.prisma.substanceAssocieeDemande.count({
      ...
      if (error instanceof Prisma.PrismaClientKnownRequestError) {
        ...
        throw new BadRequestException(
          'Failed to delete substance: ' + error.message,
        );
      } else if (error instanceof Error) {
        throw new BadRequestException(
          'Failed to delete substance: ' + error.message,
