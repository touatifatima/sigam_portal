...
export class DemandesService {
  ...
  private baseInclude = {
    ...
    procedure: { select: { id_procedure: true, statut_proc: true, date_fin_proc: true } },
    entreprise: { select: { id_entreprise: true, nom_societeFR: true, email: true, pays: { select: { id_pays: true, nom_pays: true } }, nationaliteRef: { select: { id_nationalite: true, libelle: true } } } },
 ...
 async findMany(params: {
  ...
  if (search?.trim()) {
    ...
    where.OR = [
      ...
      { entreprise: { nom_societeFR: { contains: q, mode: 'insensitive' } } },
  ...
  async getDemandeById(id: number) {
    return this.prisma.demandePortail.findUnique({
      ...
      include: {
        ...
        daira: true,
        commune: true,
        entreprise: { include: { pays: true, nationaliteRef: true } },
        expertMinier: true,
        typePermis: true,
        typeProcedure: true,
        procedure: {
