...
CREATE TABLE "utilisateurs_portail" (
    ...
    "detenteurId" INTEGER,
    "entreprise_verified" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "PermisPortail" (
    ...
    "date_option_permis" TIMESTAMP(3),
    "commentaires" TEXT,
    "validation" BOOLEAN,
    ...
    CONSTRAINT "PermisPortail_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Facture" (
    ...
    "id_demande" INTEGER NOT NULL,
    "type_facture" "FactureType" NOT NULL DEFAULT 'INVESTISSEUR',
    "devise" "DeviseFacture" NOT NULL DEFAULT 'DZD',
...
-- CreateTable
CREATE TABLE "procedure_declarations" (
    "id" SERIAL NOT NULL,
    "typeProcedureId" INTEGER NOT NULL,
    "ordre" INTEGER NOT NULL,
    "texte" TEXT NOT NULL,
    ...
    CONSTRAINT "procedure_declarations_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "idx_permis_date_octroi" ON "PermisPortail"("date_octroi" DESC);

-- CreateIndex
CREATE INDEX "idx_permis_id_statut_date_octroi" ON "PermisPortail"("id_statut", "date_octroi" DESC);

-- CreateIndex
CREATE INDEX "idx_permis_id_statut_date_expiration" ON "PermisPortail"("id_statut", "date_expiration" DESC);

-- CreateIndex
CREATE INDEX "idx_permis_code_permis" ON "PermisPortail"("code_permis");
...
-- CreateIndex
CREATE INDEX "procedure_declarations_typeProcedureId_ordre_idx" ON "procedure_declarations"("typeProcedureId", "ordre");
...
-- AddForeignKey
ALTER TABLE "permis_templates" ADD CONSTRAINT "permis_templates_permisId_fkey" FOREIGN KEY ("permisId") REFERENCES "PermisPortail"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "demFusion" ADD CONSTRAINT "demFusion_id_permisResultant_fkey" FOREIGN KEY ("id_permisResultant") REFERENCES "PermisPortail"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PermisPortail" ADD CONSTRAINT "PermisPortail_id_antenne_fkey" FOREIGN KEY ("id_antenne") REFERENCES "Antenne"("id_antenne") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PermisPortail" ADD CONSTRAINT "PermisPortail_id_detenteur_fkey" FOREIGN KEY ("id_detenteur") REFERENCES "detenteurmorale"("id_detenteur") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PermisPortail" ADD CONSTRAINT "PermisPortail_id_statut_fkey" FOREIGN KEY ("id_statut") REFERENCES "StatutPermis"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PermisPortail" ADD CONSTRAINT "PermisPortail_id_typePermis_fkey" FOREIGN KEY ("id_typePermis") REFERENCES "typepermis"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "fusionPermisSource" ADD CONSTRAINT "fusionPermisSource_id_permis_fkey" FOREIGN KEY ("id_permis") REFERENCES "PermisPortail"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "codeAssimilation" ADD CONSTRAINT "codeAssimilation_id_permis_fkey" FOREIGN KEY ("id_permis") REFERENCES "PermisPortail"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "cahiercharge" ADD CONSTRAINT "cahiercharge_permisId_fkey" FOREIGN KEY ("permisId") REFERENCES "PermisPortail"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "permis_procedure" ADD CONSTRAINT "permis_procedure_id_permis_fkey" FOREIGN KEY ("id_permis") REFERENCES "PermisPortail"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "obligationfiscale" ADD CONSTRAINT "obligationfiscale_id_permis_fkey" FOREIGN KEY ("id_permis") REFERENCES "PermisPortail"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "rapport_activite" ADD CONSTRAINT "rapport_activite_id_permis_fkey" FOREIGN KEY ("id_permis") REFERENCES "PermisPortail"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "procedure_declarations" ADD CONSTRAINT "procedure_declarations_typeProcedureId_fkey" FOREIGN KEY ("typeProcedureId") REFERENCES "typeprocedure"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
