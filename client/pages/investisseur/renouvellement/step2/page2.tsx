        ...
        if (demande.detenteur) {
          ...
          setFormData({
            infos: {
              ...
              date_constitution: formatDate(demande.detenteur.date_constitution),
    ...
    try {
      ...
      setFormData({
        infos: {
          ...
          date_constitution: formatDate(detenteur.date_constitution),
    ...
    try {
      ...
      switch (section) {
        case 'infos':
          const infosPayload = {
            ...formData.infos,
            date_constitution: formData.infos.date_constitution
              ? formData.infos.date_constitution
              : null
          };
