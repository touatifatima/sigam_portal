...
const Paiement = () => {
  ...
  const etapeIdForThisPage = useMemo(() => {
    ...
    const pathname = "operateur/cession/step4/page4";
    ...
    const byRoute = phaseEtapes.find((e: any) => {
      ...
      return (
        route === target ||
        route.endsWith(target) ||
        route.includes("step4/page4")
      );
    });
  ...
  const handlePrevious = () => {
    if (idProc) {
      ...
      router.push('/operateur/cession/step3/page3');
    }
  };
  ...
  const handlePayment = async () => {
    ...
    if (idProc) {
      const permisParam = searchParams?.get('permisId');
      router.push(
        `/operateur/cession/step4/confirmationpay?id=${idProc}${permisParam ? `&permisId=${permisParam}` : ''}`,
      );
    }
  };
  ...
  const handleCardRedirect = async () => {
    ...
    if (idProc) {
      const permisParam = searchParams?.get('permisId');
      router.push(
        `/operateur/cession/step4/paiementadahabia?id=${idProc}${permisParam ? `&permisId=${permisParam}` : ''}`,
      );
      return;
    }
    router.push('/operateur/cession/step4/paiementadahabia');
  };
            ...
            <div className={styles.container}>
              ...
              {/*<button
                ...
                onClick={() =>
                  idProc
                    ? router.push(
                        `/operateur/cession/step4/page4?id=${idProc}`,
                      )
                    : router.push('/operateur/cession/step4/page4')
                }
                type="button"
              >
                <ArrowLeft size={18} />
              ...
              <div className={styles['navigation-buttons']}>
                ...
                <button
                  ...
                  onClick={selectedMethod === "card" ? handleCardRedirect : handlePayment}
                  type="button"
                >
                  Suivant
