...
const toggleDropdown = (demandeId: number) => {
  ...
  const goToEtape = async (idProc: number, demande?: Demande) => {
    ...
    try {
      ...
      if (backendLink) {
        ...
        setError("Lien de l'�tape introuvable");
      }
    } catch (err) {
      if (startLink) {
        console.error(
          'Erreur lors de la r�cup�ration de la prochaine �tape, utilisation du fallback :',
          err,
        );
        router.push(startLink);
        return;
      }
      console.error("Erreur lors de la r�cup�ration de l'�tape :", err);
      setError("Impossible de r�cup�rer l'�tape actuelle");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDeleteProcedure = async (procedureId: number) => {
    ...
    try {
      ...
      toast.error('Erreur lors de la suppression de la proc�dure');
    }
  };
  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      const csvContent = [
        ['Code Proc�dure', 'Titulaire', 'Type de Proc�dure', 'Type Permis', 'Date Demande', 'Statut', 'Phase Actuelle'],
        ...filteredDemandes.map(d => [
          ...
          getCurrentPhase(d.procedure.ProcedureEtape)?.etape?.lib_etape || 'Non d�marr�e'
        ])
            ...
            <div className={styles.headerSection}>
              <div className={styles.titleContainer}>
                ...
                <p className={styles.pageSubtitle}>
                  Consultez, filtrez et g�rez les demandes de permis en attente de traitement
                </p>
              </div>
                ...
                <div className={styles.filtersContent}>
                  <div className={styles.filtersGrid}>
                    <div className={styles.filterGroup}>
                      <label className={styles.filterLabel}>Type de proc�dure</label>
                      <select
                    ...
                    <div className={styles.filterGroup}>
                      ...
                      <div className={styles.radioGroup}>
                        ...
                        <label
                          className={`${styles.radioOption} ${filters.sector === 'Carri�re' ? styles.selected : ''}`}
                        >
                          <input
                            type="radio"
                            name="sector"
                            checked={filters.sector === 'Carri�re'}
                            onChange={() => setFilters({ ...filters, sector: 'Carri�re' })}
                          />
                          <span className={styles.radioCustom}></span>
                          Carri�re
                        </label>
            ...
            <div className={styles.searchSection}>
              <div className={styles.searchContainer}>
                ...
                <input
                  ...
                  placeholder="Rechercher par code, titulaire ou num�ro de proc�dure..."
                  value={searchTerm}
              ...
              <div className={styles.resultsInfo}>
                <span>
                  {filteredDemandes.length} r�sultat{filteredDemandes.length !== 1 ? 's' : ''} trouv�{filteredDemandes.length !== 1 ? 's' : ''}
                </span>
              </div>
            </div>
                ...
                <div className={styles.emptyState}>
                  ...
                  <p>
                    {searchTerm || Object.values(filters).some(v => 
                      ...
                      ? 'Aucune demande ne correspond � vos crit�res de recherche. Veuillez modifier vos filtres.'
                      : 'Aucune demande en cours. Commencez par cr�er une nouvelle proc�dure.'
                    }
                  </p>
                  {(!searchTerm && !Object.values(filters).some(v => 
                    v !== 'Tous les types' && v !== 'Tous les codes' && v !== 'Tous les types de permis' &&
                    ...
                    <div className={styles.paginationInfo}>
                      {pagination.totalItems > 0 ? (
                        <span>
                          ...
                          {pagination.totalItems} entr�es
                        </span>
                      ) : (
                        <span>Aucune entr�e � afficher</span>
                      )}
                    </div>
              ...
              <div className={styles.confirmationModal}>
                <div className={styles.modalContent}>
                  ...
                  <p className={styles.modalBody}>
                    �tes-vous s�r de vouloir supprimer cette proc�dure et toutes ses
...
function getStatutLabel(statut: string) {
  switch (statut) {
    ...
    case 'Comit� de direction': return 'CD � convoquer';
    case 'retard': return 'En retard';
    case 'accept�e': return 'Accept�e';
    case 'rejete': return 'Rejet�e';
    case 'Documents': return 'R�serves';
