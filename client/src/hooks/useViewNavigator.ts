...
const permissionMap: Record<ViewType, string> = {
  ...
  'manage_navbar': 'Admin-Panel',
  'Audit_Logs': 'Audit_Logs',
  'gestion_experts': 'manage_documents',
  'Gestion_seances': 'view_dashboard',
  'Configurations': 'Admin-Panel',
  'manage_declarations': 'Admin-Panel',
  'agent-cadastre': 'manage_cadastre_documents',
  'agent_cadastre_documents': 'manage_cadastre_documents',
  'promotion': 'dashboard',
...
const routeMap: Record<ViewType, string> = {
  ...
  'manage_demandes': '/admin_panel/gestion-demandes',
  ...
  'manage_navbar': '/configuration/ConfigurationPanel?tab=navbar-config',
  ...
  'manage_declarations': '/configuration/declarations',
  'agent-cadastre': '/admin_panel/agent_cadastre/gestion_demandes_documents',
  'agent_cadastre_documents': '/admin_panel/agent_cadastre/gestion_demandes_documents',
  'promotion': '/promotion',
